...
void ofApp::setup(){
    ...
    model.loadModel("kxy2.dae", false);
...
void ofApp::keyPressed(int key){
    ...
    switch (key) {
        case '1':
            model.loadModel("hand1.obj");
            model.setPosition(modelPosition.x, modelPosition.y, modelPosition.z);
            ofEnableSeparateSpecularLight();
            break;
        case '2':
            model.loadModel("hand2.obj");
            model.setPosition(modelPosition.x, modelPosition.y, modelPosition.z);
            ofEnableSeparateSpecularLight();
            break;
        case '3':
            model.loadModel("vvague.dae");
            model.setPosition(modelPosition.x, modelPosition.y, modelPosition.z);
            ofDisableSeparateSpecularLight();
            break;
        case '4':
			model.loadModel("no1.dae");
		    model.setPosition(modelPosition.x, modelPosition.y, modelPosition.z);
            ofDisableSeparateSpecularLight();
            break;
        case '5':
            model.loadModel("hjx.obj");
            model.setPosition(modelPosition.x, modelPosition.y, modelPosition.z);
            mesh.drawWireframe();
            ofDisableSeparateSpecularLight();
            break;
